...
# Promptfoo evaluation against OpenRouter models
promptfoo:
    mkdir -p results/promptfoo
    npx promptfoo eval -c tests/promptfoo/promptfooconfig.yaml --no-table --max-concurrency 50 \

# Open the promptfoo web viewer for the most recent run
promptfoo-view:
    npx promptfoo view
